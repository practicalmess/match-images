...
export async function writeErrorToRemoteSheet(doc, imagePath) {
  const sheet = doc.sheetsByTitle["Errors"];
  await sheet.addRow([imagePath]);
  console.log(`Error processing ${imagePath.slice(-20)}`);
}
